...
export const SideBar = () => {
  ...
  return (
    <Navbar className="d-flex flex-row-reverse flex-md-column bg-my-gray p-0 m-0 flex-shrink-0">
      <ul className="d-flex flex-row flex-md-column flex-fill align-items-center justify-content-evenly my-0 py-0 py-md-4">
        {windowWidth > 500 && (
          <Avatar size="m" avatar={null} imgContainerBgClass="bg-my-dark" />
        )}
              ...
              {link.value === "Color mode" || link.value === "Sign out" ? (
                <IconButton
                  buttonProps={{
                    type: "button",
                    className:
                      "mx-md-0 p-0 mt-md-4 px-md-4 btn-link-style side-bar-link d-flex flex-column justify-content-center align-items-center bg-transparent border-0 shadow-none tr-02",
                  }}
                  icon={
                    <i
